    ...
    <section class="container single-product my-5 pt-5">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-6 col-sm-12">
                <img class="img-fluid w-100 pb-1" src="assets/img/dunk.jpeg" id="mainImg" />
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="assets/img/aj1.jpeg" width="100%" class="small-img" />
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/force.jpg" width="100%" class="small-img" />
                    </div>
                    <div class="small-img-col">
                        <img src="assets/img/aj3.jpeg" width="100%" class="small-img" />
                    </div>
